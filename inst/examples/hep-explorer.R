# Render the Hepatic Safety Explorer report from bundled example data.
#
# Usage:
#   Rscript inst/examples/hep-explorer.R [output_dir]
#
# The report is written to `output_dir` (default: tempdir()) as
# hep_explorer.html via the hep_explorer report workflow.
...
cat("Hepatic Safety Explorer report written to:", strReportPath, "\n")
