...
- **obot**. Author, maintainer.

## Citation

Source:
[`DESCRIPTION`](https://github.com/jwildfire/gsm.safety/blob/115-save-widget-report-missing-name/DESCRIPTION)

obot (2026). *gsm.safety: Safety Visualizations for Good Statistical
Monitoring Workflows*. R package version 1.5.0,
