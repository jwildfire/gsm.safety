# Render the Adverse Event Explorer report from bundled example data.
#
# Usage:
#   Rscript inst/examples/ae-explorer.R [output_dir]
#
# The report is written to `output_dir` (default: tempdir()) as
# ae_explorer.html via the ae_explorer report workflow.
...
cat("Adverse Event Explorer report written to:", strReportPath, "\n")
