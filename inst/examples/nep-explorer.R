# Render the Nephrotoxicity Explorer report from bundled example data.
#
# Usage:
#   Rscript inst/examples/nep-explorer.R [output_dir]
#
# The report is written to `output_dir` (default: tempdir()) as
# nep_explorer.html via the nep_explorer report workflow.
...
cat("Nephrotoxicity Explorer report written to:", strReportPath, "\n")
